...
from vntts.nat.config import AcousticInput
...
def loss_fn(params, aux, rng, inputs: AcousticInput, is_training=True):
    """
    It takes in the model parameters, auxiliary state, random number generator, and input data, and
    returns the loss and new auxiliary state
    
    :param params: the parameters of the model
    :param aux: auxiliary state
    :param rng: random number generator
    :param inputs: AcousticInput
    :type inputs: AcousticInput
    :param is_training: whether we're training or not, defaults to True (optional)
...
# Creating a new function with the same name as loss_fn but with the is_training parameter set to
# True.
...
def train():
    """
    We create an optimizer, then we create a function that takes in the parameters, auxiliary variables,
    random number generator, optimizer state, and inputs, and returns the loss, new parameters,
    auxiliary variables, random number generator, and optimizer state
    """
